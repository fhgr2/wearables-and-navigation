...
This software implements a routing (i.e. driving instructions) software based on the Raspberry Pi Zero. Driving instructions will be given in real-time while you're on the road using two kinds of signals: Audio messages and vibrations (generated by vibration motors to be put onto your helmet).
